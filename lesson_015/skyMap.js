class Skymap{
	...
	setDayTex(){
		if(arguments.length == 6) this.mDayTex = gl.loadCubeMap("Skymap_Day",arguments);
	 	return this;
	}
	...
	setDayTexByDom(){
		...
		this.mDayTex = gl.loadCubeMap("Skymap_Day",ary);
		return this;
	}

	setNightTex(ary){
		if(arguments.length == 6) this.mNightTex = gl.loadCubeMap("Skymap_Night",arguments);
	 	return this;
	}
	...
	setNightTexByDom(){
		...
		this.mNightTex = gl.loadCubeMap("Skymap_Night",ary);
		return this;
	}
	...
	createMesh(width,height,depth){ //,x,y,z
		...
		//Create VAO
		this.mesh = this.gl.createMeshVAO("SkymapCube",aIndex,aVert,null,null);
	}
}